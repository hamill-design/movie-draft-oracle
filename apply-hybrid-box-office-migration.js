...
const MIGRATION_FILE = 'supabase/migrations/20260108150000_recalculate_scores_hybrid_box_office.sql';
...
async function applyMigration() {
  try {
    ...
    console.log('\n✨ All scores have been recalculated with the new hybrid Box Office formula!');
