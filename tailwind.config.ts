...
export default {
	...
	theme: {
		...
		extend: {
			fontFamily: {
				'brockmann': ['Brockmann'],
				'brockmann-regular': ['Brockmann'],
				'brockmann-medium': ['Brockmann'],
				'brockmann-semibold': ['Brockmann'],
				'brockmann-bold': ['Brockmann'],
				'chaney': ['Chaney'],
				'chaney-regular': ['Chaney'],
				'chaney-wide': ['Chaney Wide'],
				'chaney-extended': ['Chaney Extended'],
				'chaney-ultra': ['Chaney Ultra Extended'],
			},
			colors: {
