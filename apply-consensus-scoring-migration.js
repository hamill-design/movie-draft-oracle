...
const MIGRATION_FILE = 'supabase/migrations/20260109150000_implement_consensus_scoring.sql';
...
async function applyMigration() {
  try {
    ...
    console.log('\n✨ All scores have been recalculated with the new consensus scoring system!');
    console.log('   - Three-layer consensus: Critics internal, Audience internal, Cross-category');
    console.log('   - Box Office-Audience consensus adjusts weights (20% base → dynamic)');
