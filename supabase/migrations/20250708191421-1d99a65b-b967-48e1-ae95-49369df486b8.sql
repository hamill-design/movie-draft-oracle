...
CREATE INDEX idx_draft_picks_calculated_score ON draft_picks(calculated_score);
CREATE INDEX idx_draft_picks_scoring_complete ON draft_picks(scoring_data_complete);
