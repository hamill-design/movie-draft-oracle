-- Update load_draft_unified to include is_ai field and fix participant_id for AI participants
...
BEGIN
  ...
  -- Fetch ALL participants for this draft (including AI participants)
