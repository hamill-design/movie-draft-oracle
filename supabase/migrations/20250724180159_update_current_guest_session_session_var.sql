-- Create a simple approach using a session variable helper function
...
-- Update the existing current_guest_session function to use session variables primarily
