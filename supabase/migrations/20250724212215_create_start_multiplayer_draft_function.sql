-- Create function to start multiplayer draft with proper permissions
CREATE OR REPLACE FUNCTION public.start_multiplayer_draft(
  p_draft_id uuid,
...
BEGIN
  ...
  -- Get the draft and verify access
