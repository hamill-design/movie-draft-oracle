-- Penalize known box-office bombs (revenue ≤ budget) by −5 on final score so they
-- are not scored as if box office were simply "missing" (100% critical blend).
