-- Fix the make_multiplayer_pick function to assign correct player IDs
...
BEGIN
  ...
  -- Calculate the correct player_id based on participant order
  ...
  SELECT 
    p_draft_id,
    v_player_id, -- Use calculated player_id instead of hardcoded 1
