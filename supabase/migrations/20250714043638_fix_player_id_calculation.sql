-- Fix the player_id calculation in make_multiplayer_pick function
...
BEGIN
  ...
  -- Calculate the correct player_id based on participant order among ALL participants
  ...
  SELECT 
    p_draft_id,
    v_player_id, -- Use calculated player_id
