...
DROP FUNCTION public.create_guest_multiplayer_draft(uuid,text,text,text,text[],text[],text);

-- Recreate the function with the new return type that returns full draft object
