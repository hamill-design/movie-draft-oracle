-- ============================================
-- APPLY THIS MIGRATION TO FIX PHOTO UPLOAD
-- ============================================
-- Copy and paste this entire file into Supabase SQL Editor
-- Then click "Run" to execute

-- Step 1: Add photo_url column to spec_drafts table
ALTER TABLE public.spec_drafts 
ADD COLUMN IF NOT EXISTS photo_url TEXT;

-- Step 2: Create storage bucket for spec draft photos (if it doesn't exist)
...
-- Step 3: Drop existing policies if they exist (to allow re-running)
...
-- Step 5: Create policy to allow authenticated users to upload
