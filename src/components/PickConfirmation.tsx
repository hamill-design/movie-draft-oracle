  ...
  return (
    <div className="w-full p-6 bg-[#FCFFFF] shadow-[0px_0px_3px_rgba(0,0,0,0.25)] rounded flex flex-col gap-6">
      <div className="flex flex-col gap-4 items-center">
        ...
        <button
          onClick={onConfirm}
          className="px-6 py-3 bg-[#FFD60A] rounded-[2px] text-[#2B2D2D] text-base font-brockmann font-semibold leading-6 tracking-[0.32px] text-center hover:bg-[#FFE97A] transition-colors duration-200"
        >
          Confirm Pick
        </button>
      </div>
