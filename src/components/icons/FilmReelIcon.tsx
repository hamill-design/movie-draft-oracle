...
export function FilmReelIcon({ className, style, theme }: IconProps) {
  ...
  return (
    <svg className={className} style={style} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M7 15.5C7.55228 15.5 8 15.9477 8 16.5C8 17.0523 7.55228 17.5 7 17.5H3C2.44772 17.5 2 17.0523 2 16.5C2 15.9477 2.44772 15.5 3 15.5H7Z" fill="currentColor"/>
      <path d="M16 21V3C16 2.44772 16.4477 2 17 2C17.5523 2 18 2.44772 18 3V21C18 21.5523 17.5523 22 17 22C16.4477 22 16 21.5523 16 21Z" fill="currentColor"/>
      <path d="M21 6.5C21.5523 6.5 22 6.94772 22 7.5C22 8.05228 21.5523 8.5 21 8.5H17C16.4477 8.5 16 8.05228 16 7.5C16 6.94772 16.4477 6.5 17 6.5H21Z" fill="currentColor"/>
      <path d="M21 15.5C21.5523 15.5 22 15.9477 22 16.5C22 17.0523 21.5523 17.5 21 17.5H17C16.4477 17.5 16 17.0523 16 16.5C16 15.9477 16.4477 15.5 17 15.5H21Z" fill="currentColor"/>
    </svg>
  );
}
