...
import { PersonIcon, CalendarIcon, MultiPersonIcon } from '@/components/icons';
import {
...
const LeagueSettings = () => {
  ...
  const handleSendEmailInvites = async () => {
    ...
    try {
      ...
      if (result.success) {
        const { sent, alreadyMember } = result.summary;
        toast({
          title: `${sent} invite${sent !== 1 ? 's' : ''} sent.`,
          description: alreadyMember > 0
            ? `${alreadyMember} ${alreadyMember !== 1 ? 'people are' : 'person is'} already in this league.`
            : undefined,
        });
        setEmailList([]);
              ...
              {activeTab === 'invite' && (
                <>
                  ...
                  >
                    <div className="flex flex-col gap-6">
                      <HeaderIcon3
                        ...
                        icon={<Mail className="w-5 h-5 text-[#907AFF]" aria-hidden />}
                      />
                      <div className="p-4 bg-teal-900 rounded flex flex-col" style={{ outline: '1px solid #B2FFEA', outlineOffset: '-1px' }}>
                        <p className="self-stretch flex flex-col text-teal-200 text-sm font-medium leading-5 font-brockmann m-0">
                          <span className="font-bold">Email invites:</span> Add addresses below, then send a batch. Invitees receive a league link — they&apos;ll join after signing in or creating an account.
                        </p>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        <Input
                          ...
                          className={cn(draftInputClass, 'min-h-12 flex-1 min-w-[200px] px-4 py-3')}
                          style={draftFieldOutline}
                        />
                        <button
                          type="button"
                          ...
                          className="inline-flex shrink-0 items-center justify-center rounded-[2px] bg-[#7142FF] px-4 py-2 text-sm font-medium leading-5 text-greyscale-blue-100 transition-colors hover:bg-[#6338e0] font-brockmann disabled:pointer-events-none disabled:opacity-50 whitespace-nowrap min-h-12"
                        >
                          Add
                        </button>
                      </div>
                      ...
                      <div className="flex flex-col gap-3">
                        <p className="m-0 text-base font-normal leading-6 text-greyscale-blue-300 font-brockmann">
                          Participants ({emailList.length}):
                        </p>
                        {emailList.length === 0 ? (
                          <p className="text-sm text-greyscale-blue-500 m-0 font-brockmann">No addresses queued yet.</p>
                        ) : (
                          <>
                            <div className="flex flex-wrap gap-2">
                              {emailList.map((email) => (
                                ...
                                >
                                  <Mail className="size-4 shrink-0 text-greyscale-blue-100 max-md:hidden" aria-hidden />
                                  <span className="text-sm font-medium leading-5 text-greyscale-blue-100 break-all font-brockmann">
                                    {email}
                                  </span>
                                  <button
                                    type="button"
                            ...
                            <button
                              ...
                              className="inline-flex w-fit items-center justify-center gap-2 rounded-[2px] bg-[#7142FF] px-4 py-2 text-sm font-medium leading-5 text-greyscale-blue-100 transition-colors hover:bg-[#6338e0] font-brockmann disabled:pointer-events-none disabled:opacity-50"
                            >
                  ...
                  >
                    <div className="flex flex-col gap-4">
                      <HeaderIcon3
                        title="Invite by Display Name"
                        icon={<Search className="w-5 h-5 text-[#907AFF]" aria-hidden />}
                      />
                      <p className="text-sm text-greyscale-blue-400 m-0 leading-relaxed font-brockmann">
                      ...
                      <div className="relative w-full max-w-lg">
                        ...
                        <Input
                          ...
                          className={cn(draftInputClass, 'pl-12 pr-4 py-3 min-h-12')}
                          style={draftFieldOutline}
                        />
                      </div>
                      {searching && (
                      ...
                      {!searching && userSearch.length >= 2 && searchResults.length === 0 && (
                        <p className="text-sm text-greyscale-blue-500 m-0 font-brockmann">No users found.</p>
                      )}
                      ...
                      <div className="flex flex-col gap-2 max-w-lg">
                        {searchResults.map((result) => (
                          <div
                            key={result.id}
                            className="flex items-center gap-3 rounded-[6px] px-3 py-2.5 font-brockmann"
                            style={{ background: '#1A1A1D', outline: '1px solid #2E2C32', outlineOffset: '-1px' }}
                          >
                            <div
                              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-sm font-semibold text-greyscale-blue-100"
                              style={{ background: '#3B2050' }}
                            >
                              {result.photo_url ? (
                                <img
                            ...
                            <p className="text-sm flex-1 truncate m-0 text-greyscale-blue-100 font-medium">
                            ...
                            <button
                              ...
                              className="inline-flex shrink-0 items-center justify-center rounded-[2px] bg-[#7142FF] px-3 py-1.5 text-xs font-medium text-greyscale-blue-100 transition-colors hover:bg-[#6338e0] font-brockmann disabled:pointer-events-none disabled:opacity-50"
                            >
                      ...
                      <div className="flex flex-col gap-2">
                        {members.map((member) => {
                          ...
                          return (
                            ...
                            >
                              <div
                                className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-sm font-semibold text-greyscale-blue-100 overflow-hidden"
                                style={{ background: member.role === 'admin' ? '#7142FF' : '#3B2050' }}
                              >
                              ...
                              <div className="flex min-w-0 flex-1 flex-col">
                                ...
                                {member.role === 'admin' && (
                                  <span className="inline-flex items-center gap-1 text-[10px] text-[#907AFF]">
                              ...
                              {member.role !== 'admin' && (
                                <button
                                  ...
                                  className="inline-flex shrink-0 items-center gap-1.5 rounded-[4px] px-3 py-1.5 text-xs font-medium text-red-400 transition-colors hover:bg-red-500/10 font-brockmann"
                                  style={{ outline: '1px solid rgba(239,68,68,0.3)', outlineOffset: '-1px' }}
                                >
