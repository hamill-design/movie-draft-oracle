    ...
    <div className="min-h-screen" style={{background: 'linear-gradient(118deg, #FCFFFF -8.18%, #F0F1FF 53.14%, #FCFFFF 113.29%)'}}>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="w-full h-full p-6 bg-greyscale-blue-100 shadow-[0px_0px_3px_rgba(0,0,0,0.25)] rounded flex-col justify-start items-start gap-3 inline-flex">
          ...
          {drafts.length === 0 ? (
            <div className="text-greyscale-blue-600 text-center py-8 text-base font-brockmann font-normal">
              No saved drafts yet. Start a new draft to see it here!
            </div>
          ) : (
            <div className="w-full flex-col justify-start items-start gap-4 flex">
              {drafts.map((draft, index) => (
                <div key={draft.id} style={{width: '100%', height: '100%', padding: 24, background: 'var(--UI-Primary, white)', boxShadow: '0px 1px 2px rgba(0, 0, 0, 0.05)', borderRadius: 8, outline: '1px var(--Greyscale-(Blue)-200, #D9E0DF) solid', outlineOffset: '-1px', justifyContent: 'space-between', alignItems: 'center', display: 'inline-flex', flexWrap: 'wrap', alignContent: 'center'}}>
                    ...
                    <div style={{alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'center', gap: 16, display: 'inline-flex', flexWrap: 'wrap', alignContent: 'center'}}>
                      <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 4, display: 'flex'}}>
                        <div style={{width: 16, height: 16, padding: 2, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
                          <Calendar size={12} style={{color: 'var(--Greyscale-(Blue)-500, #828786)'}} />
                        </div>
                      ...
                      <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 4, display: 'flex'}}>
                        <div style={{width: 16, height: 16, padding: 2, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
                          <Users size={12} style={{color: 'var(--Greyscale-(Blue)-500, #828786)'}} />
                        </div>
                        <div style={{justifyContent: 'center', display: 'flex', flexDirection: 'column', color: 'var(--Greyscale-(Blue)-500, #828786)', fontSize: 14, fontFamily: 'Brockmann', fontWeight: '500', lineHeight: 20, wordWrap: 'break-word'}}>
                      ...
                      <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 4, display: 'flex'}}>
                        <div style={{width: 16, height: 16, padding: 2, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
                          <Trophy size={12} style={{color: 'var(--Greyscale-(Blue)-500, #828786)'}} />
                        </div>
                        <div style={{justifyContent: 'center', display: 'flex', flexDirection: 'column', color: 'var(--Greyscale-(Blue)-500, #828786)', fontSize: 14, fontFamily: 'Brockmann', fontWeight: '500', lineHeight: 20, wordWrap: 'break-word'}}>
                  ...
                  <div style={{flex: '1 1 0', maxWidth: 360, minWidth: 240, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-end', gap: 16, display: 'inline-flex'}}>
                    <button 
                      ...
                      style={{alignSelf: 'stretch', paddingLeft: 16, paddingRight: 16, paddingTop: 8, paddingBottom: 8, background: 'var(--Brand-Primary, #680AFF)', borderRadius: 2, justifyContent: 'center', alignItems: 'center', display: 'inline-flex', border: 'none', cursor: 'pointer'}}
                    >
                    ...
                    <button 
                      ...
                      style={{paddingLeft: 12, paddingRight: 12, paddingTop: 8, paddingBottom: 8, borderRadius: 2, justifyContent: 'center', alignItems: 'center', gap: 8, display: 'inline-flex', border: 'none', background: 'transparent', cursor: 'pointer'}}
                    >
                      <div style={{width: 16, height: 16, padding: 2, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
                        <Trash2 size={12} style={{color: 'var(--Greyscale-(Blue)-600, #646968)'}} />
                      </div>
