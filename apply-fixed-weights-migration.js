...
const MIGRATION_FILE = 'supabase/migrations/20260109150311_fixed_box_office_weights.sql';
...
async function applyMigration() {
  try {
    ...
    console.log('\n✨ All scores have been recalculated with fixed 20/80 weights!');
    console.log('   - Box Office: 20% (fixed)');
    console.log('   - Critical Score: 80% (fixed)');
    console.log('   - No consensus modifier on weights');
